...
;
;
const runtime = "nodejs"; // ✅ IMPORTANTÍSIMO (para usar fs)
...
async function POST(req) {
    try {
        ...
        const safeName = (file.name || "imagen").replace(/\s+/g, "_").replace(/[^a-zA-Z0-9._-]/g, "");
        ...
        const result = await pool.query(`INSERT INTO plantillas_pago (cuenta_bancaria, subproducto, url)
       VALUES ($1, $2, $3)
       RETURNING *`, [
            cuentaBancaria,
            subproducto,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__137c48da._.js.map