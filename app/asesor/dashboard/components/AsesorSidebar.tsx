        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          {open && (
            <div className="min-w-0">
              ...
              <div className={["text-xs truncate", styles.subtle].join(" ")}>Panel de trabajo</div>
            </div>
          )}
        </div>
        ...
        <div className={["rounded-3xl border shadow-sm overflow-hidden", styles.card].join(" ")}>
          ...
          {open && panelSesion && (
            <div className="px-4 pb-4">
              <div className={["text-xs mb-2", styles.subtle].join(" ")}>Opciones de sesión</div>
              <button
                  ...
                  return (
                    ...
                    >
                      <span className="flex items-center gap-3 min-w-0">
                        <span className={["h-3.5 w-3.5 rounded-full shadow-sm", dot(t.id)].join(" ")} />
